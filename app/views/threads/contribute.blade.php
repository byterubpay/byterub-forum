...
@section('content')
	<div class="row">
		<div class="col-lg-12">
			...
			<p>This project is funded with <strong>BTR</strong>!</p>
			...
			<ol>
				...
				<li>Send the amount of BTR that you wish to contribute to the address:<br> <strong>{{ Config::get('byterub::address') }}</strong></li><br>
