			...
			<ul class="nav navbar-nav navbar-right navbar-collapse">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li><a href="//getmonero.org/blog/tags/monero%20missives">ByteRub Missives</a></li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="//getmonero.org/getting-started/choose">How to Choose a ByteRub Client</a></li>
						<li><a href="//getmonero.org/getting-started/running">How to Run a ByteRub Node</a></li>
						<li><a href="//getmonero.org/getting-started/donate">Donating and Sponsorships</a></li>
						<li class="divider"></li>
						<li><a href="//getmonero.org/downloads">All ByteRub Downloads</a></li>
						<li class="divider"></li>
						<li><a href="//getmonero.org/getting-started/accepting">Accepting ByteRub Payments</a></li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="//getmonero.org/knowledge-base/about">About ByteRub</a></li>
						<li><a href="//getmonero.org/knowledge-base/people">The People Behind ByteRub</a></li>
						<li><a href="//getmonero.org/knowledge-base/moneropedia">ByteRubpedia</a></li>
						<li class="divider"></li>
						...
						<li><a href="//getmonero.org/research-lab">ByteRub Research Lab</a></li>
